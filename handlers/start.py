...
async def start(_, message: Message):
    await message.reply_text(
        text="[ ](https://telegra.ph/file/ba834db90aa69f8b17b31.mp4)**𝗛𝗘𝗟𝗟𝗢 𝗧𝗛𝗘𝗥𝗘 ♥️ {}!**\n\n**𝑰 𝑪𝑨𝑵 𝑷𝑳𝑨𝒀 𝑴𝑼𝑺𝑰𝑪 𝑰𝑵 𝑽𝑶𝑰𝑪𝑬 𝑪𝑯𝑨𝑻.**𝑰𝑨𝑴 𝑨 𝑷𝑹𝑰𝑽𝑨𝑻𝑬 𝑩𝑶𝑻 𝑴𝑨𝑫𝑬 𝑾𝑰𝑻𝑯 𝑪𝑶𝑶𝑳 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺**\n\n**𝑳𝑬𝑻𝑺 𝑬𝑵𝑱𝑶𝒀 𝑻𝑯𝑬 𝑻𝑨𝑺𝑻𝑬 𝑶𝑭 𝑴𝑼𝑺𝑰𝑪 𝑩𝒀 𝑨𝑫𝑫𝑰𝑵𝑮 𝑰𝑵 𝒀𝑶𝑼𝑹 𝑮𝑹𝑶𝑼𝑷 ❤**".format(message.from_user.mention),
